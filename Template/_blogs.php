...
<section id="blogs">
    ...
    <h2 class="font-rubik" style="background-color: #ffa500"><center><b>Latest Blogs</b></center></h2>
    <a href="#top">  <img id = "B_blogs" src="Arrow.jpg" alt="Arrow Upwards" height="50px" weight="50px"></a>
        <hr>
