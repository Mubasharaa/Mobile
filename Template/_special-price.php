...
<section id="special-price">
    <div class="container">
    <h2 class="font-rubik" style="background-color: #ffa500"><center><b> Categories</b></center></h2>
    <a href="#top">  <img id="price" src="Arrow.jpg" alt="Arrow Upwards" height="50px" weight="50px"></a>
